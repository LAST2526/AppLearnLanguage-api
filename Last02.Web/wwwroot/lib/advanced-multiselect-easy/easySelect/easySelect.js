(function ($) {
    ...
    $.fn.easySelect = function (options) {
        return this.each(function () {
            ...
            const arrValueSelected = [];
            $this.find("option").each(function (indexOption) {
                if ($(this).attr("selected") == "selected") {
                    arrValueSelected.push(indexOption);
                }
            });

            if (arrValueSelected.length > 0) {
                $listItems.each(function (indexItem) {
                    if (arrValueSelected.includes(indexItem)) {
                        if (MaxAllowed == "" || typeof MaxAllowed == typeof undefined) {
                            checkItem.each(function (indexCheckItem) {
                                if (arrValueSelected.includes(indexCheckItem)) {
