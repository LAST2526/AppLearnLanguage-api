...
{
    public class UploadCsvAudioValidator : AbstractValidator<UploadCsvAudioViewModel>
    {
        private readonly ICourseService _courseService;
        public UploadCsvAudioValidator(ICourseService courseService)
        {
            ...
            RuleFor(x => x.FileContent)
                .Must(x => x.FileName.EndsWith(".csv"))
                .WithMessage(Resources.Resource.Common_Error_File_Must_Csv);
            RuleFor(x => x.FileContent)
